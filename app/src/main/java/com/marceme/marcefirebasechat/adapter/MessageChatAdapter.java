...
public class MessageChatAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    private void configureSenderView(ViewHolderSender viewHolderSender, int position) {
        ...
        viewHolderSender.getSenderMessageTextView().setText(Html.fromHtml("<b><i>"+senderFireMessage.getMessage()+"</i></b>"));
    }
    ...
    private void configureRecipientView(ViewHolderRecipient viewHolderRecipient, int position) {
        ...
        viewHolderRecipient.getRecipientMessageTextView().setText(Html.fromHtml("<b><i>"+recipientFireMessage.getMessage()+"</i></b>"));
    }
    ...
    public class ViewHolderSender extends RecyclerView.ViewHolder {
        ...
        public ViewHolderSender(View itemView) {
            ...
            mSenderMessageTextView.setClickable(true);
            mSenderMessageTextView.setMovementMethod(LinkMovementMethod.getInstance());
    ...
    public class ViewHolderRecipient extends RecyclerView.ViewHolder {
        ...
        public ViewHolderRecipient(View itemView) {
            ...
            mRecipientMessageTextView.setClickable(true);
            mRecipientMessageTextView.setMovementMethod(LinkMovementMethod.getInstance());
